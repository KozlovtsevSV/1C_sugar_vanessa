...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯСоздаюДанныеВРС(Парам01,ТабПарам)","ЯСоздаюДанныеВРС","И я создаю данные в РС ""ИмяРегистра""","","");
...
//И я создаю данные в РС "ЛюбойРегистр"
Процедура ЯСоздаюДанныеВРС(Парам01,ТабПарам) Экспорт
